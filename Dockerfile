...
RUN set -ex && \
    ldd /src/build/release/bin/vaizon
...
# Create vaizon user
RUN adduser --system --group --disabled-password vaizon && \
	mkdir -p /wallet /home/vaizon/.vaizon && \
	chown -R vaizon:vaizon /home/vaizon/.vaizon && \
	chown -R vaizon:vaizon /wallet

# Contains the blockchain
VOLUME /home/vaizon/.vaizon
...
ENTRYPOINT ["vaizon", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=22022", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=22023", "--non-interactive", "--confirm-external-bind"]
