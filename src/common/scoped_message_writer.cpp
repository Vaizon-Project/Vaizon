...
#define VAIZON_INTEGRATION_TEST_HOOKS_IMPLEMENTATION
#include "common/vaizon_integration_test_hooks.h"

// NOTE(vaizon): This file only exists because I need a way to hook into the
...
// vaizon_integration_test_hooks.h functions which isn't possible to expose in
