...
namespace service_nodes {
...
#ifndef VAIZON_ENABLE_INTEGRATION_TEST_HOOKS
  ...
  constexpr std::array<int, 3> MIN_VAIZONNET_VERSION{{0, 7, 0}};
...
// return: UINT64_MAX if (num_contributions > the max number of contributions), otherwise the amount in vaizon atomic units
