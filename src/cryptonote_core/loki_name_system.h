#ifndef VAIZON_NAME_SYSTEM_H
#define VAIZON_NAME_SYSTEM_H
...
struct tx_extra_vaizon_name_system;
class Blockchain;
}; // namespace cryptonote
...
constexpr size_t VAIZONNET_DOMAIN_NAME_MAX          = 253;
constexpr size_t VAIZONNET_ADDRESS_BINARY_LENGTH    = sizeof(crypto::ed25519_public_key);
...
inline char const *mapping_type_str(mapping_type type)
{
  switch(type)
  {
    case mapping_type::vaizonnet_1year:   return "vaizonnet_1year";
    case mapping_type::vaizonnet_2years:  return "vaizonnet_2years";
    case mapping_type::vaizonnet_5years:  return "vaizonnet_5years";
    case mapping_type::vaizonnet_10years: return "vaizonnet_10years";
...
constexpr bool is_vaizonnet_type     (lns::mapping_type type)                { return type >= mapping_type::vaizonnet_1year && type <= mapping_type::vaizonnet_10years; }
...
//                   vaizonnet, 52 character base32z string of an ed25519 public key
...
struct name_system_db
{
  ...
  bool                        save_mapping   (crypto::hash const &tx_hash, cryptonote::tx_extra_vaizon_name_system const &src, uint64_t height, int64_t owner_id, int64_t backup_owner_id = 0);
  ...
  // entry: (optional) if function returns true, the Vaizon Name System entry in the TX extra is copied into 'entry'
  bool                        validate_lns_tx       (uint8_t hf_version, uint64_t blockchain_height, cryptonote::transaction const &tx, cryptonote::tx_extra_vaizon_name_system *entry = nullptr, std::string *reason = nullptr);
