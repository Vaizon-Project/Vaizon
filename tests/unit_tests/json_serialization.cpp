        ...
        bool per_output_unlock)
    {
        ...
        for (auto const& source : sources)
        {
            ...
            if (num_outputs_to_use > 0 && is_miner_tx)
              --num_outputs_to_use; // NOTE:(vaizon): Don't try to transfer the governance reward which is always the last one
        ...
        cryptonote::vaizon_construct_tx_params tx_params;
